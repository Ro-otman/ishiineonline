...
export const env = {
  ...
  PAYMENT_WHITE_EXAM_AMOUNT: toInt(process.env.PAYMENT_WHITE_EXAM_AMOUNT, 250),
  PAYMENT_PREMIUM_DESCRIPTION:
    process.env.PAYMENT_PREMIUM_DESCRIPTION || 'Abonnement mensuel',
  PAYMENT_WHITE_EXAM_DESCRIPTION:
    process.env.PAYMENT_WHITE_EXAM_DESCRIPTION || 'Acces examen blanc',
  ...
  REVIEW_REMINDER_ENABLED: toBool(process.env.REVIEW_REMINDER_ENABLED, true),
  REVIEW_REMINDER_INTERVAL_HOURS: toInt(process.env.REVIEW_REMINDER_INTERVAL_HOURS, 12),
  REVIEW_REMINDER_MIN_DUE: toInt(process.env.REVIEW_REMINDER_MIN_DUE, 1),
  ENGAGEMENT_REMINDER_ENABLED: toBool(process.env.ENGAGEMENT_REMINDER_ENABLED, true),
  ENGAGEMENT_REMINDER_INTERVAL_HOURS: toInt(process.env.ENGAGEMENT_REMINDER_INTERVAL_HOURS, 6),
